        ...
        <div className="mt-16 lg:mt-32">
            {
                ...
                >
                    ...
                    <div className='space-y-2 lg:space-y-4 py-6 px-4 lg:py-24 lg:px-20 bg-cover bg-center bg-no-repeat object-cover' style={{ backgroundImage: `url(${shop.bannerImage})` }}>
